...
class CalendarView:
    ...
    def selection(self, day, month, year):
        ...
        canvas.create_text(w / 2 - 20, 40, fill=wh, font="HELVETICA 24 bold",
                ...
                try:
                    if int(self.appointment[i][5]) in hours and int(self.appointment[i][6]) in hours:
                        ...
                        if self.appointment[i][-3] == 1:
                            ...
                            canvas.create_text(140, y_val[value] + 38, fill=wh, font="HELVETICA 10 bold",
                                               text='Patient Name: ' + '\n\t' + self.appointment[i][1] + ' ' +
                                                    self.appointment[i][2])

                        elif self.appointment[i][-3] == 2:
                            if value < 3:
                                t1 = canvas.create_text(int(w) / 2, new_y, fill=wh, text=self.appointment[i][5] + ' AM')
                                t2 = canvas.create_text(int(w) / 2, new_y1, fill=wh,
                                                        text=self.appointment[i][6] + ' AM')
                            else:
                                t1 = canvas.create_text(int(w) / 2, new_y, fill=wh, text=self.appointment[i][5] + ' PM')
                                t2 = canvas.create_text(int(w) / 2, new_y1, fill=wh,
                                                        text=self.appointment[i][6] + ' PM')
                            ...
                            canvas.create_text(int(w) / 2 + 150, y_val[value] + 38, fill=wh, font="HELVETICA 10 bold",
                                               text='Patient Name: ' + '\n\t' + self.appointment[i][1] + ' ' +
                                                    self.appointment[i][2])
                    ...
                    try:
                        if int(self.appointment[i][5]) in hours:
                            ...
                            if self.appointment[i][-3] == 1:
                                ...
                                if value < 3:
                                    t1 = canvas.create_text(int(w) / 2, new_y, fill=wh,
                                                            text=self.appointment[i][5] + ' AM')
                                    t2 = canvas.create_text(int(w) / 2, new_y1, fill=wh,
                                                            text=self.appointment[i][6] + ' AM')
                                else:
                                    t1 = canvas.create_text(int(w) / 2, new_y, fill=wh,
                                                            text=self.appointment[i][5] + ' PM')
                                    t2 = canvas.create_text(int(w) / 2, new_y1, fill=wh,
                                                            text=self.appointment[i][6] + ' PM')
                                ...
                                canvas.create_text(int(w) / 2 + 150, y_val[value] + 38, fill=wh,
                        ...
                        try:
                            if int(self.appointment[i][6]) in hours:
                                ...
                                if int(hour) == 1 and int(minutes) > 0:
                                    ...
                                    if self.appointment[i][-3] == 1:
                                        if value1 < 3:
                                            t1 = canvas.create_text(30, new_y1, fill=wh,
                                                                    text=self.appointment[i][5] + ' AM')
                                            t2 = canvas.create_text(30, new_y, fill=wh,
                                                                    text=self.appointment[i][6] + ' AM')
                                        else:
                                            t1 = canvas.create_text(30, new_y1, fill=wh,
                                                                    text=self.appointment[i][5] + ' PM')
                                        ...
                                        canvas.create_text(140, y_val[value1] + 38, fill=wh, font="HELVETICA 10 bold",
                                                           text='Patient Name: ' + '\n\t' + self.appointment[i][
                                                               1] + ' ' + self.appointment[i][2])

                                    elif self.appointment[i][-3] == 2:
                                        if value1 < 3:
                                            t1 = canvas.create_text(int(w) / 2, new_y1, fill=wh,
                                                                    text=self.appointment[i][5] + ' AM')
                                            t2 = canvas.create_text(int(w) / 2, new_y, fill=wh,
                                                                    text=self.appointment[i][6] + ' AM')
                                        else:
                                            t1 = canvas.create_text(int(w) / 2, new_y1, fill=wh,
                                                                    text=self.appointment[i][5] + ' PM')
                                        ...
                                        canvas.create_text(int(w) / 2 + 150, y_val[value1] + 38, fill=wh,
                                                           font="HELVETICA 10 bold",
                                                           text='Patient Name: ' + '\n\t' + self.appointment[i][
                                                               1] + ' ' + self.appointment[i][2])
                            ...
                            if len(up) == 0:
                                ...
                                if res == 1:
                                    if self.appointment[i][-3] == 1:
                                        if value < 3:
                                            t1 = canvas.create_text(30, new_y, fill=wh,
                                                                    text=self.appointment[i][5] + ' AM')
                                            t2 = canvas.create_text(30, new_y1, fill=wh,
                                                                    text=self.appointment[i][6] + ' AM')
                                        else:
                                            t1 = canvas.create_text(30, new_y, fill=wh,
                                                                    text=self.appointment[i][5] + ' PM')
                                        ...
                                        canvas.create_text(140, y_val[value] + 63, fill=wh, font="HELVETICA 10 bold",
                                                           text='Patient Name: ' + '\n\t' + self.appointment[i][
                                                               1] + ' ' + self.appointment[i][2])
                                        ...
                                        canvas.create_text((w / 2) + 150, y_val[val] + 63, fill=wh,
                                                           font="HELVETICA 10 bold",
                                                           text='Patient Name: ' + '\n\t' + self.appointment[i][
                                                               1] + ' ' + self.appointment[i][2])
                                elif res == 2:
                                    if self.appointment[i][-3] == 1:
                                        ...
                                        canvas.create_text(int(w) / 2 + 150, y_val[value] + 63, fill=wh,
                                                           font="HELVETICA 10 bold",
                                                           text='Patient Name: ' + '\n\t' + self.appointment[i][
                                                               1] + ' ' + self.appointment[i][2])
                                t[int(g[0])] = t1
    ...
    def setup(self, y, m):
        ...
        header = Label(self.parent, font=("HELVETICA", 24, 'bold'), fg=wh, bg=bl,
        ...
        for w, week in enumerate(self.cal.monthdatescalendar(y, m), 2):
            for d, day in enumerate(week):
                btn = Button(self.parent, text=day.strftime('%d'), bg=bl1, width=16, height=4, fg=wh,
                             font=("ARIAL", 10, 'bold'),
                             command=lambda day=day: self.selection(day.strftime('%d'), m, y))
                    ...
                    if i[4] == day.strftime('%Y-%m-%d'):
                        ...
                        if len(di[day.strftime('%Y-%m-%d')][0]) == 1:
                            ...
                            btn['text'] = day.strftime('%d') + '\n' + di[day.strftime('%Y-%m-%d')][0] + '\n+' + str(
                                len(di[day.strftime('%Y-%m-%d')]) - 1) + ' more'
...
def Database():
    ...
    cursor = conn.cursor()
    cursor.execute(
        "CREATE TABLE IF NOT EXISTS `user` (user_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, admin_name TEXT, username TEXT, password TEXT)")
    cursor.execute(
        "CREATE TABLE IF NOT EXISTS `appointment` (app_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, firstname TEXT, surname TEXT, phone INTEGER, date DATE, start_time TEXT, end_time TEXT, bed INTEGER, sessions INTEGER, notes TEXT)")
...
def Register():
    def register_a():
        ...
        if name.get() == "" or username1.get() == "" or password1.get() == "":
            ...
            if cursor.fetchone() is not None:
                ...
                cursor.execute("INSERT INTO `user` (admin_name, username, password) VALUES(?, ?, ?)",
                               (name.get(), username1.get(), password1.get()))
                conn.commit()
    ...
    n_lbl = Label(reg, text='Name', bg=bl, fg=wh, font=("HELVETICA", 14, 'bold'))
    ...
    regist = Button(reg, text='Register', font=('HELVETICA', 16, 'bold'), width=12, fg=wh, bg=bl1, bd=4, relief=RAISED,
                    command=register_a)
    ...
    btn_reg = Button(reg, text="Login", font=('arial', 14, 'bold'), command=Back2, bg=bl1, fg=wh, width=12, bd=4,
                     relief=RAISED)
...
def HomeWindow():
    def add_app():
        def conf():
            ...
            if int(hours) >= 2 and int(minutes) > 0:
                ...
                if len(tim) == 0:
                    Database()
                    cursor.execute(
                        "INSERT INTO `appointment` (firstname, surname, phone, date, start_time, end_time, bed, sessions, notes) VALUES(?,?,?,?,?,?,?,?,?)",
                        (f_name.get(), s_name.get(), phone.get(), cal.get_date(), start.get(), end.get(), beds.get(),
                         sessions.get(), notes.get("1.0", 'end-1c')))
                    conn.commit()
                        ...
                        try:
                            if 1 in find and 2 in find:
                                ...
                                messagebox.showerror('Not available',
                                                     'This bed is not available. Try selecting the other')
                            else:
                                Database()
                                cursor.execute(
                                    "INSERT INTO `appointment` (firstname, surname, phone, date, start_time, end_time, bed, sessions, notes) VALUES(?,?,?,?,?,?,?,?,?)",
                                    (f_name.get(), s_name.get(), phone.get(), cal.get_date(), start.get(), end.get(),
                                     beds.get(), sessions.get(), notes.get("1.0", 'end-1c')))
                                conn.commit()
                                messagebox.showinfo('Successful!', 'Appointment is added successfully!')
                                f_name.delete(0, END)
                                s_name.delete(0, END)
        ...
        # Label and Entry for Start Time
        ...
        # AM/PM OptionMenu for Start Time
        start_am_pm = StringVar(root2)
        start_am_pm.set("AM")  # Default value for start time
        start_am_pm_menu = OptionMenu(root2, start_am_pm, "AM", "PM")
        start_am_pm_menu.grid(row=5, column=2, pady=10, padx=10)

        # Label and Entry for End Time
        ...
        # AM/PM OptionMenu for End Time
        end_am_pm = StringVar(root2)
        end_am_pm.set("PM")  # Default value for end time
        end_am_pm_menu = OptionMenu(root2, end_am_pm, "AM", "PM")
        end_am_pm_menu.grid(row=6, column=2, pady=10, padx=10)

        b_lbl = Label(root2, text='Bed', bg=bl, fg=wh, font=("HELVETICA", 14, 'bold'))
        b_lbl.grid(row=7, column=0, padx=10, pady=10)

        bed1 = Radiobutton(root2, font=("HELVETICA", 12), variable=beds, text='1', value=1, bg=bl, fg=wh,
                           selectcolor=bl, activebackground=bl, activeforeground=wh, tristatevalue=0)
        bed1.grid(row=7, column=1, pady=10, padx=(0, 120))

        bed2 = Radiobutton(root2, font=("HELVETICA", 12), variable=beds, text='2', value=2, bg=bl, fg=wh,
                           selectcolor=bl, activebackground=bl, activeforeground=wh, tristatevalue=0)
        ...
        def selectItem(a):
            ...
            if ask == 'yes':
                ...
                def conf():
                    ...
                    Database()
                    cursor.execute("SELECT app_id,start_time,end_time from `appointment` WHERE date = ?",
                                   (cal.get_date(),))
                    tim = cursor.fetchall()
                        ...
                        for i in tim:
                            if int(idd.get()) == int(i[0]):
                                ...
                                if first == start1 and second == end1:
                                    Database()
                                    cursor.execute(
                                        "UPDATE `appointment` SET firstname = ?, surname = ?, phone = ?, date = ?, start_time = ?, end_time = ?, sessions = ?, notes = ? WHERE app_id = ?",
                                        (
                                        f_name.get(), s_name.get(), phone.get(), cal.get_date(), start.get(), end.get(),
                                        sessions.get(), notes.get("1.0", 'end-1c'), idd.get()))
                                    conn.commit()
                                ...
                                elif time_in_range(first, second, end1) == True or time_in_range(first, second,
                                                                                                 start1) == True:
                                    messagebox.showerror('Timing Error!',
                ...
                confirm = Button(new, text='Confirm', font=("HELVETICA", 14, 'bold'), width=13, bg=bl1, fg=wh,
                                 command=conf)
                confirm.grid(row=10, columnspan=2, pady=10, padx=10)
        ...
        def selectItem(a):
            ...
            if ask == 'yes':
                ...
                messagebox.showinfo("Deletion Successful",
                                    ("The Appointment number " + str(data[0]) + ' has been deleted'))
            cursor.close()
            conn.close()
            curItem = tree.focus()
            tree.delete(curItem)
    ...
    Home.state('zoomed')
    Home.resizable(0, 0)
    head = Label(Home, text="HealthTap", font=('HELVETICA', 24, 'bold'), bg=bl, fg=wh)
    ...
    add = Button(Home, text='ADD APPOINTMENT', command=add_app, bg=bl1, fg=wh, width=20, height=2,
                 font=("HELVETICA", 15, 'bold'))
    add.grid(row=4, column=8, pady=5, padx=(40, 10))

    edit = Button(Home, text='EDIT APPOINTMENT', command=edit_app, bg=bl1, fg=wh, width=20, height=2,
                  font=("HELVETICA", 15, 'bold'))
    edit.grid(row=5, column=8, pady=5, padx=(40, 10))

    delete = Button(Home, text='DELETE APPOINTMENT', command=del_app, bg=bl1, fg=wh, width=20, height=2,
                    font=("HELVETICA", 15, 'bold'))
    delete.grid(row=6, column=8, pady=5, padx=(40, 10))

    logout = Button(Home, text='LOGOUT', command=Back, bg=bl1, fg=wh, width=20, height=2,
                    font=("HELVETICA", 15, 'bold'))
...
btn_login = Button(root, text="Login", font=('arial', 14, 'bold'), command=Login, bg=bl1, fg=wh, width=12, bd=4,
                   relief=RAISED)
...
btn_reg = Button(root, text="Register", font=('arial', 14, 'bold'), command=Register, bg=bl1, fg=wh, width=12, bd=4,
                 relief=RAISED)
